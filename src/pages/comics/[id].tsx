...
import { Comic as IComic } from '../../types/comic'
...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  const paths = data.map((item: IComic) => ({
...
export const getStaticProps: GetStaticProps<{ data: IComic }> = async (
  context
) => {
  const data = await api.getComic(Number(context.params.id))
